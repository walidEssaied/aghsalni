        ...
        <SafeAreaView style={{ backgroundColor: 'white' }}>
            <ScrollView style={styles.scrollView}>
                <View style={{ alignItems: 'center', alignSelf: 'center' }}>
                    <Text style={{ color: '#4A919E', fontWeight: 'bold', marginBottom: 20, fontSize: 20, marginTop: 30 }}>Réservez maintenant dans la station  </Text>
                ...
                <View style={styles.containerr}>
                    <Text style={{ color: '#4A919E', fontWeight: 'bold' }}>Saisir les informations de la réservation</Text>
                </View>
                <View  >
                    <TextInput
                        style={styles.input}
